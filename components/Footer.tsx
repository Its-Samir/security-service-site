...
export default function Footer() {
	return (
		<footer className="flex-col sm:flex-row sm:flex justify-between sm:space-y-0 space-y-4 sm:items-end bg-slate-800 text-slate-400 p-4 hover:text-white rounded-sm">
			<div className="flex flex-col gap-3">
				<h1 className="text-xl md:text-2xl font-sans font-bold">Logo</h1>
				<hr className="border-slate-400" />
				<div className="flex items-center gap-2">
					<FaLocationDot /> <span>123, Area One, City, Country</span>
				</div>
			</div>
